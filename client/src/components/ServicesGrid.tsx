            ...
            return (
              ...
              >
                <CardHeader className="p-5 sm:p-6 lg:p-8">
                  ...
                  <CardTitle className="font-heading text-xl sm:text-2xl mb-2 text-white" data-testid={`text-service-detail-title-${index}`}>
                    {service.title}
                  </CardTitle>
                  <p className="text-white/80 text-sm sm:text-base" data-testid={`text-service-detail-description-${index}`}>
                    {service.description}
                  </p>
                </CardHeader>
